      ...
      <div style={{flex:1,maxWidth:480,margin:"0 auto",width:"100%",padding:"16px 16px 100px"}}>
        ...
        {active==="notes" && (
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
            {notes.map(n=>(
              <div key={n.id} style={{background:n.color,borderRadius:16,padding:14,position:"relative",boxShadow:"0 2px 12px rgba(0,0,0,0.08)",minHeight:100}}>
                <button onClick={()=>deleteItem("notes",n.id)} style={{position:"absolute",top:8,left:8,background:"rgba(0,0,0,0.1)",border:"none",borderRadius:"50%",width:22,height:22,cursor:"pointer",fontSize:11,display:"flex",alignItems:"center",justifyContent:"center"}}>×</button>
                <h3 style={{margin:"0 0 8px",fontSize:14,fontWeight:700,color:"#333"}}>{n.title}</h3>
